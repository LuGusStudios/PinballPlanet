	...
	public partial class XCProject : System.IDisposable
	{
		...
		public XCProject( string filePath ) : this()
		{
			...
			if( filePath.EndsWith( ".xcodeproj" ) ) {
				this.projectRootPath = System.IO.Path.GetDirectoryName( filePath );
			...
			projectFileInfo = new FileInfo( System.IO.Path.Combine( this.filePath, "project.pbxproj" ) );
		...
		public PBXDictionary AddFile( string filePath, PBXGroup parent = null, string tree = "SOURCE_ROOT", bool createBuildFiles = true, bool weak = false )
		{
			...
			if( System.IO.Path.IsPathRooted( filePath ) ) {
				...
				absPath = System.IO.Path.Combine( Application.dataPath, filePath );
			}
			...
			if( !string.IsNullOrEmpty( fileReference.buildPhase ) && createBuildFiles ) {
				...
				switch( fileReference.buildPhase ) {
					case "PBXFrameworksBuildPhase":
						...
						string libraryPath = System.IO.Path.Combine( "$(SRCROOT)", System.IO.Path.GetDirectoryName( filePath ) );
		...
		public void Backup()
		{
			string backupPath = System.IO.Path.Combine( this.filePath, "project.backup.pbxproj" );
