...
namespace UnityEditor.FacebookEditor
{
    public class FixupFiles
    {
        ...
        {
			string fullPath = System.IO.Path.Combine(path, System.IO.Path.Combine("Libraries", "RegisterMonoModules.cpp"));
        ...
        public static void AddVersionDefine(string path)
        {
			...
			string fullPath = System.IO.Path.Combine(path, System.IO.Path.Combine("Libraries", "RegisterMonoModules.h"));
            string data = Load(fullPath);
        ...
        {
			string fullPath = System.IO.Path.Combine(path, System.IO.Path.Combine("Classes", "UnityAppController.mm"));
            string data = Load(fullPath);
