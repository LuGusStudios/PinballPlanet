...
public class GamesPlayedCondition : Condition
{
	...
	// Constructor.
	public GamesPlayedCondition(Func<int, int, bool> comparer, int amount)
	{
		// Store values.
		_amount = amount;
		_comparer = comparer;
	...
	{
		return _comparer(PlayerData.use.numberOfGamesPlayed, _amount);
	}
